export function createProductCardHtml(postsData, cardsContainer) {
    postsData.forEach(({ productId, imgSrc, additionalImgSrcFirst, additionalImgSrcSecond, productName, productPrice, breadcrumbs, description }) => {
        const productCardEl = `
            <div class="product-description">
                ...
                <div class="product-description__right">
                    ...
                    <details class="product-description__details">
                        ...
                        <p>Чтобы любимые украшения оставались с вами как можно дольше, очень важно во время их эксплуатации
                            придерживаться следующих правил:</p>
                        <ul>
                            <li>Изделия не должны контактировать с водой, спиртовыми растворами, кремами, духами,
                                дезодорантами и средствами для волос.<br>
                            </li>
                            <li>Не рекомендуем в украшениях посещать фитнес, солярий, пляж, СПА процедуры и заниматься
                                уборкой.<br>
                            </li>
                            <li>Не наносите парфюмерию, крема и лосьоны, если на вас украшения. Дайте время средствам
                                высохнуть или впитаться.<br>
                            </li>
                            <li>Очищать бижутерию можно мягкой тканевой салфеткой, либо ватой с использованием специальных
                                чистящих средств.<br>
                            </li>
                            <li>Храните изделия отдельно друг от друга, на открытой поверхности. Используйте пыльники только
                            ...
                            <li>В украшениях не рекомендуется купаться. Хлорированная и соленая вода являются агрессивной
                                химической средой для покрытий ювелирных сплавов.<br>
                            </li>
                        </ul>
